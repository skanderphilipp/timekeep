...
export const AllVariants: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 0, width: 220, border: "1px solid var(--ao-border-secondary)", borderRadius: "var(--ao-radius-md)", overflow: "hidden", padding: 4 }}>
      ...
      <hr style={{ margin: "2px 0", border: "none", borderTop: "1px solid var(--ao-border-secondary)" }} />
