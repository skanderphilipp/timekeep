...
export const Primary: Story = {
  render: () => (
    <DetailGrid title="System Health">
      <DetailItem label="Status"><StatusBadge status="online" label="Healthy" /></DetailItem>
      <DetailItem label="Version">v1.2.3</DetailItem>
      <DetailItem label="Database"><StatusBadge status="online" label="Connected" /></DetailItem>
...
export const AllVariants: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--ao-spacing-6)", padding: "var(--ao-spacing-4)", maxWidth: 400 }}>
      <DetailGrid title="Account">
        ...
        <DetailItem label="Permissions">
          <Text variant="caption" color="tertiary">read:punches write:punches read:devices write:devices</Text>
        </DetailItem>
      </DetailGrid>
      <DetailGrid title="Device Information">
        ...
        <DetailItem label="Status"><StatusBadge status="online" label="Connected" /></DetailItem>
      </DetailGrid>
    </div>
  ),
};
...
export const ContextEmployeeDetail: Story = {
  ...
  render: () => (
    <DetailGrid title="Fatima Hassan — PIN 146">
      ...
      <DetailItem label="Status"><Tag text="Active" color="green" /></DetailItem>
