...
export const AllVariants: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--ao-spacing-4)", padding: "var(--ao-spacing-4)" }}>
      <div style={{ width: 150 }}>
        <span style={{ fontSize: 12, color: "var(--ao-font-color-tertiary)", display: "block", marginBottom: 4 }}>Single line — overflows</span>
        <OverflowingTextWithTooltip text="Main Gate — SpeedFace-V5L [TI] Serial Number CQZ7232960836" />
      </div>
      <div style={{ width: 150 }}>
        <span style={{ fontSize: 12, color: "var(--ao-font-color-tertiary)", display: "block", marginBottom: 4 }}>Multi-line (max 2 rows)</span>
