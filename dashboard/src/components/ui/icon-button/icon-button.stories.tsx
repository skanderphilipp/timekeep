  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--ao-spacing-4)", padding: "var(--ao-spacing-4)" }}>
      <div style={{ display: "flex", gap: "var(--ao-spacing-2)", alignItems: "center" }}>
        ...
        <span style={{ fontSize: 12, color: "var(--ao-font-color-tertiary)" }}>md / secondary (default)</span>
      </div>
      <div style={{ display: "flex", gap: "var(--ao-spacing-2)", alignItems: "center" }}>
        <IconButton aria-label="View" size="sm"><IconEye size={14} /></IconButton>
        <IconButton aria-label="Edit" size="sm"><IconPencil size={14} /></IconButton>
        <IconButton aria-label="Delete" size="sm"><IconTrash size={14} /></IconButton>
        <span style={{ fontSize: 12, color: "var(--ao-font-color-tertiary)" }}>sm / secondary</span>
      </div>
      <div style={{ display: "flex", gap: "var(--ao-spacing-2)", alignItems: "center" }}>
        <IconButton aria-label="Primary" accent="primary"><IconPlus size={16} /></IconButton>
        <IconButton aria-label="Secondary" accent="secondary"><IconPencil size={16} /></IconButton>
        <IconButton aria-label="Tertiary" accent="tertiary"><IconTrash size={16} /></IconButton>
        <span style={{ fontSize: 12, color: "var(--ao-font-color-tertiary)" }}>primary / secondary / tertiary</span>
      </div>
    </div>
  ),
};
...
export const ContextTableActions: Story = {
  ...
  render: () => (
    <ActionGroup>
      ...
      <IconButton aria-label="Delete employee" accent="tertiary"><IconTrash size={16} /></IconButton>
    </ActionGroup>
  ),
};
