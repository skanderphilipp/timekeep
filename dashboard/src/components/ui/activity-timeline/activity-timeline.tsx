...
/**
 * Activity timeline — vertical event list with colored icons and relative timestamps.
 *
...
export function ActivityTimeline({
  ...
  if (loading) {
    return (
      <div data-slot="activity-timeline" className={clsx(styles.container, className)}>
