...
import { Dialog as DialogComponent, Form, FormActions, Button, SchemaForm } from "@/components/ui";
 ...
 */
export function ChangePasswordDialog({ open, onClose, user, onSubmit }: ChangePasswordDialogProps) {
  const { _ } = useLingui();
