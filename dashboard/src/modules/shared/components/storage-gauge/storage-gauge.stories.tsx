...
export const EdgeCases: Story = {
  ...
  render: () => (
    ...
    >
      <StorageGauge percentage={0} current={0} capacity={100000} label="Empty" />
      <StorageGauge percentage={50} current={50000} capacity={100000} label="Half" />
      <StorageGauge percentage={100} current={100000} capacity={100000} label="Full" />
    </div>
  ),
};
